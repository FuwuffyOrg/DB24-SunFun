...
ALTER TABLE `giornata`
  ...
  ADD KEY `FK Periodo Giornata` (`fk_periodo_inizio`,`fk_periodo_fine`);
...
ALTER TABLE `discussione`
  MODIFY `num_discussione` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Numero della discussione in ordine di apretura.', AUTO_INCREMENT=26;

ALTER TABLE `risposta`
  MODIFY `num_risposta` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Numero della risposta di una discussione.', AUTO_INCREMENT=3;
